  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white shadow-sm">
      ...
      <div className="bg-[#f2f5f7] border-b border-slate-200/50">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-x-4 gap-y-1 px-3 py-1.5 text-xs text-slate-600 md:px-4">
          ...
          <div className="flex flex-wrap items-center gap-x-3 gap-y-0.5">
            ...
            <button type="button" className="p-0.5 text-slate-600 hover:text-primary-600" aria-label="Search">
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 md:px-6" aria-label="Main navigation">
        <Link href="/" className="flex items-center gap-3 shrink-0">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-primary-500 text-white text-xl font-bold">
            A
          </div>
          <div>
            <span className="block text-lg font-bold tracking-tight text-slate-800">ASIAN ACADEMY</span>
            <span className="block text-xs font-medium text-primary-500 uppercase tracking-wider">
